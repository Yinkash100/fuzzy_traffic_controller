...
no_vehicle_current_lane['too-small'] = fuzz.trimf(no_vehicle_current_lane.universe, [0, 0, 8])
no_vehicle_current_lane['small'] = fuzz.trimf(no_vehicle_current_lane.universe, [4, 10, 16])
no_vehicle_current_lane['much'] = fuzz.trimf(no_vehicle_current_lane.universe, [10, 16, 20])
no_vehicle_current_lane['too-much'] = fuzz.smf(no_vehicle_current_lane.universe, 16, 20)
# no_vehicle_current_lane.view()

no_vehicle_other_lane['too-small'] = fuzz.trimf(no_vehicle_other_lane.universe, [0, 0, 8])
no_vehicle_other_lane['small'] = fuzz.trimf(no_vehicle_other_lane.universe, [4, 10, 16])
no_vehicle_other_lane['much'] = fuzz.trimf(no_vehicle_other_lane.universe, [10, 16, 20])
no_vehicle_other_lane['too-much'] = fuzz.smf(no_vehicle_other_lane.universe, 16, 20)
# no_vehicle_other_lane.view()

waiting_time_current_lane['negligible'] = fuzz.trimf(waiting_time_current_lane.universe, [0, 0, 24])
waiting_time_current_lane['okay'] = fuzz.trimf(waiting_time_current_lane.universe, [16, 36, 50])
waiting_time_current_lane['much'] = fuzz.trimf(waiting_time_current_lane.universe, [36, 56, 76])
waiting_time_current_lane['too-much'] = fuzz.smf(waiting_time_current_lane.universe, 76, 120)
# waiting_time_current_lane.view()

emv_waiting_time_green_lane['negligible'] = fuzz.trimf(emv_waiting_time_green_lane.universe, [0, 0, 12])
emv_waiting_time_green_lane['okay'] = fuzz.trimf(emv_waiting_time_green_lane.universe, [8, 18, 25])
emv_waiting_time_green_lane['much'] = fuzz.trimf(emv_waiting_time_green_lane.universe, [18, 25, 38])
emv_waiting_time_green_lane['too-much'] = fuzz.smf(emv_waiting_time_green_lane.universe, 38, 50)

emv_waiting_time_red_lane['negligible'] = fuzz.trimf(emv_waiting_time_red_lane.universe, [0, 0, 12])
emv_waiting_time_red_lane['okay'] = fuzz.trimf(emv_waiting_time_red_lane.universe, [8, 18, 25])
emv_waiting_time_red_lane['much'] = fuzz.trimf(emv_waiting_time_red_lane.universe, [18, 25, 38])
emv_waiting_time_red_lane['too-much'] = fuzz.smf(emv_waiting_time_green_lane.universe, 38, 50)
